    ...
    <>
      ...
      <main className="min-h-screen bg-bg text-white">
        ...
        <div className="pt-40 pb-32 px-6 md:px-16 max-w-5xl mx-auto">
          ...
          {/* Footer note */}
          <div className="mt-20 pt-10 flex flex-col sm:flex-row items-center justify-between gap-4" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
            <p className="font-mono text-xs tracking-[0.3em]" style={{ color: "rgba(255,255,255,0.15)" }}>
              BUILT WITH NEXT.JS · SPOTIFY WEB API · TOO MUCH MUSIC
            </p>
            <a
              href="https://github.com/mihir7121/HookD"
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2.5 font-mono text-xs tracking-[0.15em] transition-opacity hover:opacity-100"
